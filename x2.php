...
<body class="cs_dark">
  ...
  <div class="cs_section_heading cs_style_1 cs_type_3 text-center">
    <div class="container">
      <p class="cs_section_subtitle cs_accent_color cs_fs_21 mb-0 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">Configuracion</p>
      <div class="cs_height_20 cs_height_lg_10"></div>
      <h2 class="cs_section_title cs_fs_68 mb-0">ProRusty x2</h2>
    </div>
  </div>
  <div class="cs_height_125 cs_height_lg_50"></div>
  <!-- End Page Heading -->
  <div class="container">
    <p class="m-0 text-center">Ambiente de juego diseñado para un combate PvP y justo.</p>
    ...
    <ul class="cs_order-summery">
      ...
      <li>
        <p>WIPES MAPA:</p>
        <h3>MARTES 18HS [ARG]</h3>
      </li>
      <li>
        <p>WIPES FULL:</p>
        <h3>VIERNES 18HS [ARG]</h3>
      </li>
      <li>
        <p>TAMAÑO MAPA</p>
        <h3>4500</h3>
    ...
    <div class="cs_shop-card">
      ...
      <table class="border-bottom-0">
        <tbody>
          ...
          <tr>
            <td>INSTANT BARREL</td>
            <td class="text-end">SI</td>
          </tr>
          <tr>
            <td>AUTOMATIC AUTHORIZATION</td>
            <td class="text-end">SI</td>
          </tr>
          <tr>
            <td class="cs_semi_bold">CLANES</td>
            <td class="text-end">SI</td>
          </tr>
          <tr class="cs_semi_bold">
            <td class="pb-0">ALIANZAS CLANES</td>
            <td class="text-end pb-0">NO</td>
          </tr>
        </tbody>
      </table>
    </div>
