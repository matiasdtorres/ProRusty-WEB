...
<head>
    ...
    <!-- Site Title -->
    <title>ProRusty - Portfolio Details</title>
    <?php
  ...
  <body class="cs_dark">
    ...
    <div class="cs_section_heading cs_style_1 cs_type_3">
      <div class="container">
        <p class="cs_section_subtitle cs_accent_color cs_fs_21 mb-0 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">Portfolio Details</p>
        <div class="cs_height_20 cs_height_lg_10"></div>
        <h2 class="cs_section_title cs_fs_68 mb-0">Awesome colorful artwork</h2>
      </div>
    </div>
    ...
    <div class="container">
      <div class="cs_portfolio_details">
        <img src="assets/img/others/portfolio_details_1.jpg" alt="Thumb">
        <div class="cs_height_100 cs_height_lg_40"></div>
        <div class="cs_portfolio_details_in">
          <ul class="cs_portfolio_details_info cs_mp0">
            <li>
              <h3 class="cs_fs_21 mb-0 cs_semibold">Client:</h3>
              <p class="mb-0">Andrew romania</p>
            </li>
            <li>
              <h3 class="cs_fs_21 mb-0 cs_semibold">Location:</h3>
              <p class="mb-0">United Kindom</p>
            </li>
            <li>
              <h3 class="cs_fs_21 mb-0 cs_semibold">Budget:</h3>
              <p class="mb-0">$2500</p>
            </li>
            <li>
              <h3 class="cs_fs_21 mb-0 cs_semibold">Project Completed:</h3>
              <p class="mb-0">11 August,2022</p>
            </li>
          </ul>
          <div class="cs_portfolio_details_right">
            <h2>Project Summary</h2>
            <p>Colorful artwork is a creative project that aims to explore the beauty and diversity of colorful artwork. The project seeks to showcase the myriad of ways in which colors can be used to convey emotions, ideas, and expressions in the world of art. <br>The project will feature a collection of artworks created by talented artists from different parts of the world. Each artwork will be selected based on its unique use of color, and how it contributes to the overall composition of the piece. The project will feature a diverse range of art forms, including paintings, drawings, digital art, and mixed media.</p>
            <p>Through this project, we aim to celebrate the power of color in art, and how it can be used to convey a wide range of emotions and meanings. We hope to inspire a deeper appreciation of art and its ability to connect with people on a visceral level. In addition to the artwork, the project will also feature interviews with the artists, where they will discuss their inspiration, creative process, and their use of color in their art. This will provide a unique insight into the creative minds of the artists and help the audience understand the meaning and symbolism behind their art.</p>
          </div>
        </div>
        <div class="cs_height_115 cs_height_lg_60"></div>
        <div class="cs_portfolio_details_gallery">
          <div><img src="assets/img/others/portfolio_details_2.jpg" alt="Thumb"></div>
          <div><img src="assets/img/others/portfolio_details_3.jpg" alt="Thumb"></div>
          <div><img src="assets/img/others/portfolio_details_4.jpg" alt="Thumb"></div>
        </div>
      </div>
      <div class="cs_height_90 cs_height_lg_60"></div>
      <div class="cs_page_navigation cs_center">
        <div>
          <a href="#" class="cs_text_btn cs_type1">
            <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0.469669 5.46967C0.176777 5.76256 0.176777 6.23744 0.469669 6.53033L5.24264 11.3033C5.53553 11.5962 6.01041 11.5962 6.3033 11.3033C6.59619 11.0104 6.59619 10.5355 6.3033 10.2426L2.06066 6L6.3033 1.75736C6.59619 1.46447 6.59619 0.989593 6.3033 0.696699C6.01041 0.403806 5.53553 0.403806 5.24264 0.696699L0.469669 5.46967ZM26 5.25L1 5.25V6.75L26 6.75V5.25Z" fill="currentColor"></path>
            </svg>            
            <span>Prev Project</span>               
          </a>
        </div>
        <div>
          <a href="#" class="cs_text_btn">
