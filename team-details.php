...
<head>
  ...
  <body class="cs_dark">
    ...
    <div class="cs_section_heading cs_style_1 cs_type_3 ">
      <div class="container">
        <p class="cs_section_subtitle cs_accent_color cs_fs_21 mb-0 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">React Developer</p>
        <div class="cs_height_20 cs_height_lg_10"></div>
        <h2 class="cs_section_title cs_fs_68 mb-0">James Berline</h2>
      </div>
    ...
    <section>
      <div class="container">
        <div class="row">
          <div class="col-xl-5">
            <img src="assets/img/others/team_details_1.jpg" alt="Member" class="w-100">
          </div>
          <div class="col-xl-6 offset-xl-1">
            <div class="cs_height_50 cs_height_lg_30"></div>
            <h2 class="cs_fs_38">Bio & experience</h2>
            <p>Meet James Berline, a skilled React developer based in the USA. With years of more experience and a passion for building exceptional web applications, James Berline has become an expert in the field. As a freelance developer, they have worked with clients from around the world, delivering high-quality solutions that exceed her limit expectations. In their free time, James Berline enjoys exploring new technologies and mentoring junior developers. She love also song writing.</p>
            <p>Versatile developer with expertise in React and front-end development. He also have nice extensive experience with SQL databases. With a strong work ethic and attention to detail, they deliver high-quality solutions that exceed expectations.</p>
            ...
            <div class="cs_progressbar cs_style_1">
              <div class="cs_progressbar_heading d-flex justify-content-between align-items-center">
                <h3 class="cs_medium m-0 cs_fs_16">React Development</h3>
            ...
            <div class="cs_progressbar cs_style_1">
              <div class="cs_progressbar_heading d-flex justify-content-between align-items-center">
                <h3 class="cs_medium m-0 cs_fs_16">Front-End Development</h3>
            ...
            <div class="cs_progressbar cs_style_1">
              <div class="cs_progressbar_heading d-flex justify-content-between align-items-center">
                <h3 class="cs_medium m-0 cs_fs_16">Sql Database</h3>
