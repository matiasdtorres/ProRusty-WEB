...
<head>
    ...
    <!-- Site Title -->
    <title>ProRusty - Blog With Sidebar</title>
    <?php
        ...
        <div class="row cs_gap_y_60">
          <div class="col-lg-8">
            <div class="cs_post cs_style_4">
              <div class="cs_post_thumb_wrap position-relative">
                <a href="blog-details.php" class="cs_post_thumb cs_radius_5"><img src="assets/img/blog/post_1.jpg" alt="Thumb"></a>
                <div class="cs_categories">
                  <a href="#" class="cs_category">Branding</a>
                </div>
              </div>
              <h2 class="cs_post_title cs_fs_50"><a href="blog-details.php">Strategies for building a strong brand identity</a></h2>
            ...
            <div class="cs_post cs_style_4">
              <div class="cs_post_thumb_wrap position-relative">
                <a href="blog-details.php" class="cs_post_thumb cs_radius_5"><img src="assets/img/blog/post_2.jpg" alt="Thumb"></a>
                <div class="cs_categories">
                  <a href="#" class="cs_category">Branding</a>
                </div>
              </div>
              <h2 class="cs_post_title cs_fs_50"><a href="blog-details.php">Best SEO practices for better web page rankings</a></h2>
              <p class="cs_post_subtitle">From social media to SEO, branding to lead generation, our team of experienced marketers shares their expertise and industry knowledge to help you stay ahead of the curve...</p>
              <a href="#" class="cs_post_btn">
                <span>Read More</span>
                <svg width="51" height="16" viewBox="0 0 51 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cs_post cs_style_4">
              <div class="cs_post_thumb_wrap position-relative">
                <a href="blog-details.php" class="cs_post_thumb cs_radius_5"><img src="assets/img/blog/post_3.jpg" alt="Thumb"></a>
                <div class="cs_categories">
                  <a href="#" class="cs_category">Branding</a>
                </div>
              </div>
            ...
            <div class="cs_post cs_style_4">
              <div class="cs_post_thumb_wrap position-relative">
                <a href="blog-details.php" class="cs_post_thumb cs_radius_5"><img src="assets/img/blog/post_4.jpg" alt="Thumb"></a>
                <div class="cs_categories">
                  <a href="#" class="cs_category">Branding</a>
                </div>
              </div>
            ...
            <div class="cs_post cs_style_4">
              <div class="cs_post_thumb_wrap position-relative">
                <a href="blog-details.php" class="cs_post_thumb cs_radius_5"><img src="assets/img/blog/post_5.jpg" alt="Thumb"></a>
                <div class="cs_categories">
                  <a href="#" class="cs_category">Branding</a>
                </div>
              </div>
              <h2 class="cs_post_title cs_fs_50"><a href="blog-details.php">Inspiration for creating compelling visuals</a></h2>
              <p class="cs_post_subtitle">From social media to SEO, branding to lead generation, our team of experienced marketers shares their expertise and industry knowledge to help you stay ahead of the curve...</p>
              <a href="#" class="cs_post_btn">
                <span>Read More</span>
                <svg width="51" height="16" viewBox="0 0 51 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="cs-sidebar_item">
                ...
                <ul class="cs-recent_posts">
                  <li>
                    <div class="cs-recent_post">
                      <a href="#" class="cs-recent_post_thumb">
                        <div class="cs-recent_post_thumb_in cs-bg" data-src="assets/img/blog/post_1.jpg"></div>
                      </a>
                      <div class="cs-recent_post_info">
                        <h3 class="cs-recent_post_title">
                          <a href="#">Marketing tips, trend...</a>
                        </h3>
                        <div class="cs-recent_post_date cs-primary_40_color">15 Aug 2023</div>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="cs-recent_post">
                      <a href="#" class="cs-recent_post_thumb">
                        <div class="cs-recent_post_thumb_in cs-bg" data-src="assets/img/blog/post_2.jpg"></div>
                      </a>
                      <div class="cs-recent_post_info">
                        <h3 class="cs-recent_post_title">
                          <a href="#">Best SEO practices...</a>
                        </h3>
                        <div class="cs-recent_post_date cs-primary_40_color">15 Aug 2023</div>
                      </div>
                    </div>
                  ...
                  <li>
                    <div class="cs-recent_post">
                      <a href="#" class="cs-recent_post_thumb">
                        <div class="cs-recent_post_thumb_in cs-bg" data-src="assets/img/blog/post_3.jpg"></div>
                      </a>
                      <div class="cs-recent_post_info">
                        <h3 class="cs-recent_post_title">
                          <a href="#">Strategies for build...</a>
                        </h3>
                        <div class="cs-recent_post_date cs-primary_40_color">15 Aug 2023</div>
                      </div>
                    </div>
                  ...
                  <li>
                    <div class="cs-recent_post">
                      <a href="#" class="cs-recent_post_thumb">
                        <div class="cs-recent_post_thumb_in cs-bg" data-src="assets/img/blog/post_4.jpg"></div>
                      </a>
                      <div class="cs-recent_post_info">
                        <h3 class="cs-recent_post_title">
                          <a href="#">Inspiration for creat...</a>
                        </h3>
                        <div class="cs-recent_post_date cs-primary_40_color">15 Aug 2023</div>
                      </div>
                    </div>
