...
<head>
    ...
    <!-- Site Title -->
    <title>ProRusty - Servide Details</title>
    <?php
  ...
  <body class="cs_dark">
    ...
    <div class="cs_section_heading cs_style_1 cs_type_3 ">
      <div class="container">
        <p class="cs_section_subtitle cs_accent_color cs_fs_21 mb-0 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">On Page Optimiztion</p>
        <div class="cs_height_20 cs_height_lg_10"></div>
        <h2 class="cs_section_title cs_fs_68 mb-0">Improving website visibility and <br>user experience</h2>
      </div>
    ...
    <!-- End Page Heading -->
    <!-- Start Service Info -->
    <div class="cs_service_info">
      <div class="container">
        <div class="row align-items-center cs_gap_y_40">
          <div class="col-lg-6">
            <div class="cs_service_info_thumb cs_bg_filed" data-src="assets/img/others/service_details_2.png"></div>
          </div>
          <div class="col-lg-6">
            <div class="row cs_gap_y_40">
              <div class="col-sm-6">
                <div class="cs_number_box cs_style_1">
                  <h3 class="cs_number_box_number cs_semibold cs_accent_bg cs_fs_29 cs_center">01</h3>
                  <h2 class="cs_number_box_title cs_fs_29 cs_semibold">Keywords</h2>
                  <p class="mb-0">One provide moment. Interesting an a upse you side it all the and don't listen. Cnfiden picture she one the what I nor least absolutes heavily polimer.</p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="cs_number_box cs_style_1">
                  <h3 class="cs_number_box_number cs_semibold cs_accent_bg cs_fs_29 cs_center">02</h3>
                  <h2 class="cs_number_box_title cs_fs_29 cs_semibold">SEO Writing</h2>
                  <p class="mb-0">One provide moment. Interesting an a upse you side it all the and don't listen. Cnfiden picture she one the what I nor least absolutes heavily polimer.</p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="cs_number_box cs_style_1">
                  <h3 class="cs_number_box_number cs_semibold cs_accent_bg cs_fs_29 cs_center">03</h3>
                  <h2 class="cs_number_box_title cs_fs_29 cs_semibold">Visual Assets</h2>
                  <p class="mb-0">One provide moment. Interesting an a upse you side it all the and don't listen. Cnfiden picture she one the what I nor least absolutes heavily polimer.</p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="cs_number_box cs_style_1">
                  <h3 class="cs_number_box_number cs_semibold cs_accent_bg cs_fs_29 cs_center">04</h3>
                  <h2 class="cs_number_box_title cs_fs_29 cs_semibold">Image Optimization</h2>
                  <p class="mb-0">One provide moment. Interesting an a upse you side it all the and don't listen. Cnfiden picture she one the what I nor least absolutes heavily polimer.</p>
                </div>
              </div>
            </div>
    ...
    <div class="cs_about cs_style_2 cs_type_2">
      <div class="container">
        <div class="row align-items-center cs_gap_y_40">
          <div class="col-lg-6">
            <div class="cs_section_heading cs_style_1">
              <h2 class="cs_section_title cs_fs_50 mb-0 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">What you will get from this service?</h2>
              <div class="cs_height_30 cs_height_lg_30"></div>
              <p class="m-0">Our team, specializing in strategic digital marketing, partners with the world's leading brands. Breaking from the norm, we push boundaries and imaginative thinking, consumer behavior, and data-driven design with advanced.</p>
            </div>
            <div class="cs_height_40 cs_height_lg_30"></div>
            <ul class="cs_list cs_style_1 cs_primary_font cs_primary_color cs_semibold cs_mp0 cs_fs_21">
              <li>
                <i class="fa-regular fa-circle-check"></i>Compatible with all modern browsers
              </li>
              <li>
                <i class="fa-regular fa-circle-check"></i>Designing content with AI power
              </li>
              <li>
                <i class="fa-regular fa-circle-check"></i>Trending marketing tools involve
              </li>
              <li>
                <i class="fa-regular fa-circle-check"></i>Powerful market strategy use
              </li>
            </ul>
            <div class="cs_height_40 cs_height_lg_30"></div>
            <a href="#" class="cs_btn cs_style_1">Check Live Projects <span><i class="fa-solid fa-arrow-right"></i></span></a>
          </div>
          <div class="col-lg-6">
            <div class="cs_about_thumb">
              <div class="cs_about_thumb_in cs_bg_filed" data-src="assets/img/others/service_details_1.jpg"></div>
            </div>
          </div>
        </div>
      </div>
