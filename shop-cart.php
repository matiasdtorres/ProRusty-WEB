...
<head>
  ...
  <!-- Site Title -->
  <title>ProRusty - Shop Cart</title>
...
<body class="cs_dark">
  ...
  <div class="cs_section_heading cs_style_1 cs_type_3 text-center">
    <div class="container">
      ...
      <h2 class="cs_section_title cs_fs_68 mb-0">Shopping cart</h2>
    </div>
  </div>
      ...
      <div class="col-xl-4">
        <div class="cs_shop-side-spacing">
          <div class="cs_shop-card">
            ...
            <div class="cs_height_30 cs_height_lg_30"></div>
            <button class="cs_product_btn cs_semi_bold w-100">Procced To Checkout</button>
          </div>
          <div class="cs_height_30 cs_height_lg_30"></div>
        </div>
      </div>
